...
const uint8_t SansSerif_plain_8Bitmaps[] PROGMEM = {
...
const GFXglyph SansSerif_plain_8Glyphs[] PROGMEM = {
...
const GFXfont SansSerif8 PROGMEM = {
(uint8_t  *)SansSerif_plain_8Bitmaps,(GFXglyph *)SansSerif_plain_8Glyphs,0x20, 0x7E, 10};